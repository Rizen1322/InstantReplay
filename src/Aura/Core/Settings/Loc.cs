...
public static class Loc
{
    ...
    private static readonly Dictionary<string, (string ru, string en)> S = new()
    {
        ...
        ["tip_recording"]  = ("Aura: идёт запись в файл", "Aura: recording to file"),
        ["tip_buffering"]  = ("Aura: повтор пишется", "Aura: buffering"),
        ["tip_off"]        = ("Aura: выключено", "Aura: off"),
        ["update_found"]   = ("Доступно обновление {0} в разделе «Приложение»",
                              "Update {0} available in the App section"),
        ["driver_found"]   = ("Вышел драйвер NVIDIA {0}, подробности в разделе «Система»",
                              "NVIDIA driver {0} is out, see the System section"),
